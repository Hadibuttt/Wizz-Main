...
<head>
    ...
    <title>Wizz Express | @yield('title')</title>
                    ...
                    <div class="col-xl-12">
                        <div class="row d-flex justify-content-between align-items-center">
                            <div class="header-info-left">
                                <ul>     
                                    <li>Phone: +92-51-8442246</li>
                                    <li>Email: info@wizz-express.com</li>
                                </ul>
                            </div>
                                ...
                                <div class="main-menu d-none d-lg-block">
                                    <nav> 
                                        <ul id="navigation">                                                                                          
                                            ...
                                            <li><a class="{{ (request()->is('service')) ? 'active' : '' }}" href="{{ url('/service') }}">Our Services</a></li>
                                            <li><a class="{{ (request()->is('contact')) ? 'active' : '' }}" href="{{ url('/contact') }}">Contact Us</a></li>
                                            <li><a class="{{ (request()->is('careers*')) ? 'active' : '' }}" href="{{ url('/careers') }}">Careers</a></li>
                                        </ul>
                                    </nav>
                                </div>
                                <!-- Header-btn -->
                                <div class="header-right-btn d-none d-lg-block ml-20">
                                    <a href="{{ url('/contact') }}" class="btn header-btn">Get A Quote</a>
                                </div>
                            </div>
                        </div> 
                        <!-- Mobile Menu -->
